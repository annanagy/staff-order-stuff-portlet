...
/**
 * Provides the local service interface for Consumption. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Anna & Ádám
 * @see ConsumptionLocalServiceUtil
...
public interface ConsumptionLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ConsumptionLocalServiceUtil} to access the consumption local service. Add custom service methods to {@link com.liferay.support.stafforderstuff.service.impl.ConsumptionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
